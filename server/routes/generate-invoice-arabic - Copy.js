          ...
          <style>
            ...
            * {
            ...
            .title-section {
              ...
              border-left: 4px solid #3acabb;
              border-right: 4px solid #3acabb;
            }
            ...
            .buyer-header .text-right {
              text-align: right;
              direction: rtl;
            }

            .buyer-header .text-left {
              text-align: left;
              direction: ltr;
            }
            ...
            .items-table th {
              background: linear-gradient(135deg, #3acabb 0%, #2c9ea6 100%);
              color: white;
              font-weight: 600;
              padding: 8px 4px;
              text-align: center;
            ...
            .total-row, .info-row {
              ...
              align-items: center;
              padding: 5px 0;
              border-bottom: 1px solid #3acabb;
              font-size: 12px;
            }

            .total-row:last-child {
              border-bottom: none;
              border-top: 2px solid #3acabb;
              padding-top: 12px;
              margin-top: 5px;
              font-weight: bold;
              font-size: 14px;
          ...
          <div class="document">
            ...
            <div class="header">
              ...
              <div class="logo-container">
                <img src="${invoice.companyLogo || 'http://localhost:5173/logo-text.png'}" alt="Company Logo" crossOrigin="anonymous" />
              </div>
            ...
            <div class="buyer-info">
              ...
              <div class="buyer-content">
                <div class="text-right">
                  <p><strong>رقم تسجيل ضريبة القيمة المضافة</strong></p>
                </div>
                <div class="text-left">
                  <p><strong>VAT Registration Number</strong></p>
                </div>
              </div>
              
              <div class="buyer-content">
                <div class="text-right">
                  <div class="bg-gray">${toArabicDigits(invoice.company?.vat_number || '399999999800003')}</div>
                </div>
                <div class="text-left">
              ...
              <div class="buyer-content">
                <div class="text-right">
                  <div class="bg-gray">${invoice.company?.address || 'الأمير سلطان'}</div>
                </div>
                <div class="text-left">
                  ...
                  ${invoice.items?.map((item, index) => {
                    ...
                    return `
                      <tr>
                        ...
                        <td class="number-cell">${formatCurrency(totalWithVat)}</td>
                      </tr>
                    `;
